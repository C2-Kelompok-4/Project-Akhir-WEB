...
<head>
   ...
   <title>Checkout 4Your Phone</title>
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" min="0" name="flat" required placeholder="Your Address">
         </div>
         <div class="inputBox">
            <span>Address:</span>
         ...
         <div class="inputBox">
            <span>Province :</span>
            <input type="text" name="country" required placeholder="Province">
         </div>
         <div class="inputBox">
            <span>Pin Code :</span>
